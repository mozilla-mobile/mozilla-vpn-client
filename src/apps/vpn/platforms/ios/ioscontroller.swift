...
public class IOSControllerImpl : NSObject {
    ...
    @objc func connect(dnsServer: String, serverIpv6Gateway: String, serverPublicKey: String, serverIpv4AddrIn: String, serverPort: Int,  allowedIPAddressRanges: Array<VPNIPAddressRange>, reason: Int, isGleanDebugTagActive: Bool, isSuperDooperFeatureActive: Bool, installationId: String, failureCallback: @escaping () -> Void) {
        ...
        let _ = TunnelManager.withTunnel { tunnel in
            ...
            return self.configureTunnel(config: config, reason: reason, serverName: serverIpv4AddrIn + ":\(serverPort )", isGleanDebugTagActive: isGleanDebugTagActive, isSuperDooperFeatureActive: isSuperDooperFeatureActive, installationId: installationId, failureCallback: failureCallback)
        }
    }

    func configureTunnel(config: TunnelConfiguration, reason: Int, serverName: String, isGleanDebugTagActive: Bool, isSuperDooperFeatureActive: Bool, installationId: String, failureCallback: @escaping () -> Void) {
        let _ = TunnelManager.withTunnel { tunnel in
            ...
            configHack["isGleanDebugTagActive"] = isGleanDebugTagActive
