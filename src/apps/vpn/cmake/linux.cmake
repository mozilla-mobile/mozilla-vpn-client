...
target_sources(mozillavpn PRIVATE
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/backendlogsobserver.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/backendlogsobserver.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/dbusclient.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/dbusclient.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxappimageprovider.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxappimageprovider.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxapplistprovider.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxapplistprovider.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxcontroller.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxcontroller.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxdependencies.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxdependencies.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxnetworkwatcher.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxnetworkwatcher.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxnetworkwatcherworker.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxnetworkwatcherworker.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxpingsender.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxpingsender.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxsystemtraynotificationhandler.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/linuxsystemtraynotificationhandler.h
)
...
target_sources(mozillavpn PRIVATE
   ...
   ${CMAKE_SOURCE_DIR}/3rdparty/wireguard-tools/contrib/embeddable-wg-library/wireguard.h
    ...
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/apptracker.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/apptracker.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/dbusservice.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/dbusservice.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/dbustypeslinux.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/dnsutilslinux.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/dnsutilslinux.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/iputilslinux.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/iputilslinux.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/linuxdaemon.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/pidtracker.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/pidtracker.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/polkithelper.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/polkithelper.h
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/wireguardutilslinux.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/wireguardutilslinux.h
)
...
configure_file(${CMAKE_CURRENT_SOURCE_DIR}/platforms/linux/daemon/org.mozilla.vpn.dbus.service.in
