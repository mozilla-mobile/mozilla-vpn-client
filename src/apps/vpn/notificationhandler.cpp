...
void NotificationHandler::serverUnavailableNotification(bool pingRecieved) {
  ...
  QString title =
      pingRecieved
          ? i18nStrings->t(I18nStrings::ServerUnavailableModalHeaderText)
          : i18nStrings->t(I18nStrings::ServerUnavailableModalHeaderText2);
  QString message =
      pingRecieved
          ? i18nStrings->t(
                I18nStrings::
                    ServerUnavailableNotificationBodyTextFireWallBlocked)
          : i18nStrings->t(I18nStrings::ServerUnavailableModalBodyText2)
                .arg(MozillaVPN::instance()
                         ->controller()
                         ->currentServer()
