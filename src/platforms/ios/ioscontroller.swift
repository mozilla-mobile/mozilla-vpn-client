...
public class IOSControllerImpl: NSObject {
    ...
    @objc func connect(serverData: [VPNServerData], permitLocalNetworkFeatures: Bool, allowedIPAddressRanges: [VPNIPAddressRange], reason: Int,
        ...
        TunnelManager.withTunnel { tunnel in
            ...
            return self.configureTunnel(configs: configs, reason: reason, serverName: serverName, permitLocalNetworkFeatures: permitLocalNetworkFeatures, gleanDebugTag: gleanDebugTag, isSuperDooperFeatureActive: isSuperDooperFeatureActive, installationId: installationId, disconnectOnErrorCallback: disconnectOnErrorCallback, onboardingCompletedCallback: onboardingCompletedCallback, vpnConfigPermissionResponseCallback: vpnConfigPermissionResponseCallback)
        }
    }
