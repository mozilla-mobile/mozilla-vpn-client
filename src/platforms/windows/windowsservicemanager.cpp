...
WindowsServiceManager::WindowsServiceManager(){
    ...
    m_serviceManager = OpenSCManager( 
        NULL,                    // local computer
...
void WindowsServiceManager::pollStatus(){
    ...
    logger.log() << "Polling Status" << m_state_target << "wanted, has: " << state;
