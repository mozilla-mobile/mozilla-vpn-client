...
void TestChaCha20Poly::rfc7539_data() {
  ...
  QTest::addRow("Test Vector for AEAD_CHACHA20_POLY1305")
      << QByteArray::fromHex(
             ...
             "742e")
      << QByteArray::fromHex("50515253c0c1c2c3c4c5c6c7")
      << QByteArray::fromHex(
             "808182838485868788898a8b8c8d8e8f"
             "909192939495969798999a9b9c9d9e9f")
      << QByteArray::fromHex("070000004041424344454647")
      << QByteArray::fromHex(
             ...
             "6116")
      << QByteArray::fromHex("1ae10b594f09e26a7e902ecbd0600691");
  ...
  QTest::addRow("ChaCha20-Poly1305 AEAD Decryption")
      << QByteArray::fromHex(
             ...
             "726573732e2fe2809d")
      << QByteArray::fromHex("f33388860000000000004e91")
      << QByteArray::fromHex(
      ...
      << QByteArray::fromHex(
             ...
             "a6ad5cb4022b02709b")
      << QByteArray::fromHex("eead9d67890cbb22392336fea1851f38");
}
