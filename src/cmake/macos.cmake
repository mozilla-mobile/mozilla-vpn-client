...
set(WIREGUARD_GO_ENV
    ...
    CGO_ENABLED=1
    GO111MODULE=on
    CGO_CFLAGS='-g -O3 -mmacos-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET} -isysroot ${OSX_SDK_PATH} -target ${CMAKE_SYSTEM_PROCESSOR}-apple-darwin'
    CGO_LDFLAGS='-g -O3 -mmacos-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET} -isysroot ${OSX_SDK_PATH} -target ${CMAKE_SYSTEM_PROCESSOR}-apple-darwin'
)
