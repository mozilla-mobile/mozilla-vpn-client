 ...
 *
 * This is an abstract class. Platform and protocol-specific implementations must override the pure virtual methods.
 */
...
class Tunnel : public QObject {
    ...
    public:
         ...
         * @param config Interface configuration containing server details, secrets, and routing
         ...
         * @return JSON object containing connection status, bandwidth stats, and metadata
         *
        ...
        /**
         * @brief Checks if seamless server switching is supported for the given config
         * @param config Target configuration to switch to
         * @return true if server can be switched without full reconnection, false otherwise
         *
        ...
        QMap<InterfaceConfig::HopType, ConnectionState> connections() const { return m_connections; }
