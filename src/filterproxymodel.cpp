...
void FilterProxyModel::setSource(QAbstractListModel* sourceModel) {
  ...
  if (sourceModel) {
      connect(sourceModel, &QAbstractItemModel::rowsInserted, this, &FilterProxyModel::countChanged);
      connect(sourceModel, &QAbstractItemModel::rowsRemoved, this, &FilterProxyModel::countChanged);
      connect(sourceModel, &QAbstractItemModel::modelReset, this, &FilterProxyModel::countChanged);
      connect(sourceModel, &QAbstractItemModel::layoutChanged, this, &FilterProxyModel::countChanged);
