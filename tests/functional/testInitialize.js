...
describe('Initialize', function() {
  ...
  //   await
  //   vpn.waitForQuery(queries.screenInitialize.SIGN_UP_BUTTON.visible()); let
  //   signupScreenEvents = await vpn.waitForGleanValue("impression",
  //   "signupScreen", "main"); assert.strictEqual(signupScreenEvents.length,
  //   1); const signupScreenExtras = signupScreenEvents[0].extra;
  ...
  //   await vpn.waitForQueryAndClick(
  //     queries.screenInitialize.GET_HELP_LINK.visible());
  //   const getHelpEvents = await vpn.waitForGleanValue("interaction",
  //   "getHelpSelected", "main"); assert.strictEqual(getHelpEvents.length, 1);
  ...
  //   await vpn.waitForQueryAndClick(
  //     queries.screenInitialize.SIGN_UP_BUTTON.visible());
  //   const signupButtonEvents = await vpn.waitForGleanValue("interaction",
  //   "signupSelected", "main"); assert.strictEqual(signupButtonEvents.length,
  //   1); const signupButtonExtras = signupButtonEvents[0].extra;
  ...
  //   await vpn.waitForQueryAndClick(
  //     queries.screenInitialize.ALREADY_A_SUBSCRIBER_LINK.visible());
  //   const alreadyASubscriberButtonEvents = await
  //   vpn.waitForGleanValue("interaction", "alreadyASubscriberSelected",
  //   "main"); assert.strictEqual(alreadyASubscriberButtonEvents.length, 1);
  //   const alreadyASubscriberButtonExtras =
  //   alreadyASubscriberButtonEvents[0].extra;
  //   assert.strictEqual(telemetryScreenId,
  //   alreadyASubscriberButtonExtras.screen);
  // });
  // });
});
