...
const settingsScreen = {
  ...
  tipsAndTricksView:
      {SCREEN: 'settingsTipsAndTricksPage', BACK: 'tipsAndTricks-back'},
  ...
  systemPreferenceView: {
    ...
    languageSettingsView: {systemLanguageToggle: 'settingsSystemLanguageToggle'}
  },
...
const getHelpScreen = {
  ...
  giveFeedbackView: {SCREEN: 'giveFeedbackView'},
...
const homeScreen = {
  ...
  TUTORIAL_LIST_HIGHLIGHT:
      'layoutAll/columnAll/tutorialsSectionAll/tipsAndTricksSetionLoader/tutorialList/highlightedTutorial',

  selectSingleHopServerView: {
    BACK_BUTTON: 'serverListBackButton',
    MULTIHOP_SELECTOR_TAB:
  ...
  serverListView: {
    ...
    generateCityId: (countryId, cityName) => {
      return countryId + '/serverCityList/serverCity-' +
