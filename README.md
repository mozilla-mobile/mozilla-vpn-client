...
- [Linux](INSTALLING.md#linux)
    - [Flatpak](INSTALLING.md#flatpak)
    - [Debian & Ubuntu (.deb)](INSTALLING.md#debian--ubuntu-deb)
    - [Fedora (.rpm)](INSTALLING.md#fedora-rpm)
    - [From Source](INSTALLING.md#from-source)
- [Android](INSTALLING.md#android)
    - [Google Play](INSTALLING.md#google-play)
    - [Non Google Play devices](INSTALLING.md#non-google-play-devices)
    - [From Source](INSTALLING.md#from-source-1)
- [Windows](INSTALLING.md#windows)
    - [Windows 10&11 x64](INSTALLING.md#windows-1011-x64)
    - [Windows 11 aarch64](INSTALLING.md#windows-11-aarch64)
    - [From Source](INSTALLING.md#from-source-2)
- [macOS](INSTALLING.md#macos)
    - [From Source](INSTALLING.md#from-source-3)
- [iOS](INSTALLING.md#ios)
    - [From Source](INSTALLING.md#from-source-4)
- [WASM](INSTALLING.md#wasm)
    - [From Taskcluster artifacts](INSTALLING.md#from-taskcluster-artifacts)
    - [From Source](INSTALLING.md#from-source-5)
