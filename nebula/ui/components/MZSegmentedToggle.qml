    ...
    RowLayout {
        ...
        Repeater {
            ...
            delegate: MZButtonBase {
                ...
                Accessible.name: (root.selectedIndex === index ? MZI18n.AccessibilitySelectedAndItemName.arg(label.text) : label.text) + MZI18n.AccessibilityCurrentIndexFocusedOfTotalItemsInGroup.arg(index + 1).arg(options.count)
