...
CheckBox {
    ...
    states: [
        State {
            ...
            PropertyChanges {
                ...
                border.color: checkBox.checked || checkBox.activeFocus ? MZTheme.colors.buttonColor : MZTheme.colors.fontColor
            }
        ...
        State {
            ...
            PropertyChanges {
                target: checkBoxIndicator
                border.color: checkBox.checked ? MZTheme.colors.buttonSelectedPressed : MZTheme.colors.fontColorDark
            }
        },
        State {
            ...
            PropertyChanges {
                target: checkBoxIndicator
                border.color: if(checkBox.enabled) checkBox.checked || checkBox.activeFocus ? MZTheme.colors.buttonSelectedHovered : MZTheme.colors.fontColorDark
            }
    ...
    indicator: Rectangle {
        ...
        border.color: checkBox.checked ? MZTheme.colors.buttonColor : MZTheme.colors.fontColor
        border.width: 2
