...
QT_MOC_LITERAL(3, 14, 6), // "avatar"
QT_MOC_LITERAL(4, 21, 11), // "displayName"
QT_MOC_LITERAL(5, 33, 5), // "email"
QT_MOC_LITERAL(6, 39, 10) // "maxDevices"

    },
    "User\0changed\0\0avatar\0displayName\0email\0"
    "maxDevices"
};
...
void User::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (User::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&User::changed)) {
                *result = 0;
                return;
            }
        }
