...
QT_MOC_LITERAL(1, 11, 13), // "logEntryAdded"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 3) // "log"

    },
    "LogHandler\0logEntryAdded\0\0log"
};
...
void LogHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->logEntryAdded((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (LogHandler::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogHandler::logEntryAdded)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LogHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_LogHandler.data,
...
// SIGNAL 0
void LogHandler::logEntryAdded(const QByteArray & _t1)
{
