...
QT_MOC_LITERAL(1, 14, 13), // "quitRequested"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 13) // "pipeReadReady"

    },
    "SignalHandler\0quitRequested\0\0pipeReadReady"
};
...
void SignalHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignalHandler::quitRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SignalHandler::quitRequested()
{
