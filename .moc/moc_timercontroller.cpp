...
void TimerController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TimerController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TimerController::staticMetaObject = { {
    QMetaObject::SuperData::link<ControllerImpl::staticMetaObject>(),
    qt_meta_stringdata_TimerController.data,
    qt_meta_data_TimerController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TimerController::qt_metacast(const char *_clname)
{
    ...
    return ControllerImpl::qt_metacast(_clname);
}

int TimerController::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ControllerImpl::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
