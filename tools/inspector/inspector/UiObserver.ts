...
class _UIObserver extends GenericDispatcher {
  ...
  constructor () {
    super()
    Client.on('qml_tree', (e) => this.onIncomingViewTree(e.detail))
    Client.on('view_tree', (e) => this.onIncomingViewTree(e.detail))
    Client.on('screen_capture', (e) => this.onIncomingScreen(e.detail))
