...
#[no_mangle]
pub extern "C" fn glean_memory_distribution_accumulate(id: u32, sample: i64) {
    with_metric!(
...
#[no_mangle]
pub extern "C" fn glean_memory_distribution_test_get_value(
    id: u32,
    ping_name: FfiStr
) -> *mut c_char {
...
#[no_mangle]
pub extern "C" fn glean_memory_distribution_test_get_num_recorded_errors(
    id: u32,
