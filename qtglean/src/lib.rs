...
#[no_mangle]
pub extern "C" fn glean_initialize(is_telemetry_enabled: bool, data_path: FfiStr, channel: FfiStr, activate_debug_tag: bool) {
    ...
    if activate_debug_tag {
        glean::set_debug_view_tag("VPNTest");
    }
}
