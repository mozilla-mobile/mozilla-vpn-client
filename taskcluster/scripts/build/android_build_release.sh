...
mv /builds/worker/artifacts/prospector-vpn-x86_64-release-unsigned.apk /builds/worker/artifacts/mozillavpn-x86_64-release.apk
mv /builds/worker/artifacts/prospector-vpn-arm64-v8a-release-unsigned.apk /builds/worker/artifacts/mozillavpn-arm64-v8a-release.apk
mv /builds/worker/artifacts/prospector-vpn-armeabi-v7a-release-unsigned.apk /builds/worker/artifacts/mozillavpn-armeabi-v7a-release.apk
mv /builds/worker/artifacts/prospector-vpn-x86-release-unsigned.apk /builds/worker/artifacts//mozillavpn-x86-release.apk
