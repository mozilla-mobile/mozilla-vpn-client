...
cmake --build $BUILD_DIR --target vpn
...
Copy-Item -Path "$BUILD_DIR/src/apps/vpn/CMakeFiles/mozillavpn.dir/vc140.pdb" -Destination "$ARTIFACTS_PATH/Mozilla VPN.pdb"
...
if ($env:MOZ_SCM_LEVEL -eq "3") {
    ...
    sentry-cli-Windows-x86_64.exe debug-files upload --org mozilla -p vpn-client $BUILD_DIR/src/apps/vpn/CMakeFiles/mozillavpn.dir/vc140.pdb
}
