...
cmake --build build -j8 --target vpn
cp build/src/apps/vpn/mozillavpn.wasm wasm
cp build/src/apps/vpn/mozillavpn.js wasm
cp build/src/apps/vpn/qtloader.js wasm
