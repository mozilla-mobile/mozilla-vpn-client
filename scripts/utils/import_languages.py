...
# Step 3
title("Step 3", "Write resource file to import the locales that are ready...")
...
# TODO: How should we run lupdate to find new string content?

# Step 5
title("Step 5", "Generate translation resources...")
